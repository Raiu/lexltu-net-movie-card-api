...
public class MovieService(ApiDbContext dbContext, IMapper autoMapper, IUnitOfWork unitOfWork)
    : ApiService<Movie, MovieDto>(dbContext, autoMapper, unitOfWork),
        IMovieService
{
...
/* public async Task<T> PartialAsync<T>(int id, JsonPatchDocument patchDocument)
{
    var movie =
